...
do
  ...
  do 
  echo ${run} ${yy} ${kk}
  ../bin/cdftransport -pm -u ${datadir}/${run}_${yy}0101_${yy}1231_uo_v0.nc -v ${datadir}/${run}_${yy}0101_${yy}1231_vo_v0.nc -noheat -time ${kk} -zlimit 1000 <section_26n.dat
  rename -v ATL_ ATL_${yy}_month_${kk}_ ATL_*.nc
  mv ATL_*.nc Data/data_26n/${run} 
  done
done
